...
insert into csm_permission (id, name, permission) values(unhex(replace('ba690893-ff53-4280-9919-59b150ff0eec','-','')), 'Assign permission', 'entity:CsmUser,entity:CsmUserGroup');
